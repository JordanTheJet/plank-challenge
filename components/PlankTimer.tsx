          ...
          <div className="flex flex-col items-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 max-w-md w-full">
              <div className="text-center mb-6">
                ...
                <p className="text-6xl font-bold text-purple-600 font-mono">
              ...
              <div className="border-t pt-6 mb-6">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span>Grant camera access when prompted</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-purple-600 mr-2">2.</span>
                    <span>Get ready for 3-second countdown</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-purple-600 mr-2">3.</span>
                    <span>Hold your plank until timer completes</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-bold text-purple-600 mr-2">4.</span>
                    <span>Video auto-downloads when finished</span>
                  </li>
                </ul>
              </div>
